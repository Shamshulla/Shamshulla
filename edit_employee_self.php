...
<!-- <?php
    ...
    $sql = "SELECT * FROM employee_details as emp INNER JOIN login_emp as log on emp.Login_id = log.Login_id WHERE log.Login_id='$userID'";
    $res = $conn->query($sql);
    if($res->num_rows > 0) {
        $row = $res->fetch_assoc();
    }
...
<head>
 ...
 <body style="background-image:url('https://images.unsplash.com/photo-1475965894430-b05c9d13568a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80')">
     ...
     <form action="../action/e_action.php" method="post" id="form" >
         <div class="container">
             <div class="form-group col-12 col-sm-6 col-xs-6">
                 ...
                 <input type="text" name="firstName" placeholder="Enter First Name" class="form-control" value="<?php echo $row['FirstName'] ?>" required><br>
                </div>
                
                <div class="form-group col-12 col-sm-6 col-xs-6">
                    <lable for="second_name"><b>Last Name</b></label><br>
                    <input type="text" name="lastName" placeholder="Enter Last Name" class="form-control" value="<?php echo $row['LastName'] ?>" required><br>
                </div>
                
                <div class="form-group col-12 col-sm-6 col-xs-6">
                    <label for="email">Email Address(Personal):</label>
                    <input type="email" name="mail" placeholder="Enter like example@example.com" class="form-control" value="<?php echo $row['Personal_Mail'] ?>" required><br>
                </div>
                ...
                <div class="form-group col-12 col-sm-6 col-xs-6">
                    ...
                    <input type="number" name="pnumber" placeholder="Enter Phone Number" class="form-control" value="<?php echo $row['Phone_Number'] ?>" required><br>
                </div>
                    
                <div class="form-group col-12 col-sm-6 col-xs-6">
                    <lable for="civil"><b>Civil Status</b></label><br>
                    <input type="text" name="civil_status" placeholder="Enter Civil Status" class="form-control" value="<?php echo $row['Civil_Status'] ?>" required><br>
                </div>
                
                <div class="form-group col-12 col-sm-6 col-xs-6">
                    <lable for="home_address"><b>Home Address</b></label><br>
                    <input type="text" name="home_add" placeholder="Enter your Home Address" class="form-control" value="<?php echo $row['Home_address'] ?>" required><br>
                </div>
                ...
                <div class="form-group col-12 col-sm-6" align = "center">
        ...
        <div class="container">
            <div class="form-group col-12 col-sm-6 col-xs-6">
                ...
                <input type="text" name="c_name" placeholder="Enter Company Name" class="form-control" value="<?php echo $row['Company_Name'] ?>" required><br>
            </div>
            
            <div class="form-group col-12 col-sm-6 col-xs-6">
                <lable for="department"><b>Department Name</b></label><br>
                <input type="text" name="department" placeholder="Enter Department Name" class="form-control" value="<?php echo $row['Department_Name'] ?>" required><br>
            </div>

            <div class="form-group col-12 col-sm-6 col-xs-6">
                <lable for="title-position"><b>Job Title / Position</b></label><br>
                <input type="text" name="position" placeholder="Enter Job Title / Position" class="form-control" value="<?php echo $row['Job_Title/Position'] ?>" required><br>
            </div>
    ...
    <div class = "container">
        ...
        <input type="text" name="username" placeholder="Enter User Name" class="form-control" value="<?php echo $row['username'] ?>" required><br>
        ...
        <div style="text-align:center">
            ...
            <input type="submit" name="update" value="Update" class="btn btn-primary" id="btn">
        </div>
    </div>
</form>
